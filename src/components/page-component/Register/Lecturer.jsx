...
export default function RegisterTeacherInfo() {
  ...
  const handleSubmit = (e) => {
    ...
    const teacherInfo = { name, phone, email };
    console.log("Teacher info submitted:", teacherInfo);
  ...
  return (
    <div className="pro-container">
      <h2 className="pro-h2">Teacher Information Registration</h2>
